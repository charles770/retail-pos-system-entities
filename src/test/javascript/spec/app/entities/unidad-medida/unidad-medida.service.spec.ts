...
describe('Service Tests', () => {
  describe('UnidadMedida Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new UnidadMedida(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a UnidadMedida', async () => {
      ...
      it('should update a UnidadMedida', async () => {
        const returnedFromService = Object.assign(
          {
            nombreUnidadMedida: 'BBBBBB',
            abreviatura: 'BBBBBB'
          },
          elemDefault
        );
      ...
      it('should return a list of UnidadMedida', async () => {
        const returnedFromService = Object.assign(
          {
            nombreUnidadMedida: 'BBBBBB',
            abreviatura: 'BBBBBB'
      ...
      it('should delete a UnidadMedida', async () => {
