...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    @Query(value = "select distinct producto from Producto producto left join fetch producto.impuestos",
    ...
    @Query("select distinct producto from Producto producto left join fetch producto.impuestos")
    List<Producto> findAllWithEagerRelationships();

    @Query("select producto from Producto producto left join fetch producto.impuestos where producto.id =:id")
