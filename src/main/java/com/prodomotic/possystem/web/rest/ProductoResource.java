...
/**
 * REST controller for managing {@link com.prodomotic.possystem.domain.Producto}.
 */
@RestController
@RequestMapping("/api")
public class ProductoResource {
    ...
    public List<Producto> getAllProductos(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
